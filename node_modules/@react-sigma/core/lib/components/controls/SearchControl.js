...
const SearchControl = ({ id, className, style }) => {
    ...
    return (react_1.default.createElement("div", Object.assign({}, htmlProps),
        react_1.default.createElement("label", { htmlFor: inputId, style: { display: "none" } }, "Search a node"),
        react_1.default.createElement("input", { id: inputId, type: "text", placeholder: "Search...", list: `${inputId}-datalist`, value: search, onChange: onInputChange }),

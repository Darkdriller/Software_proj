...
const FullScreenControl = ({ id, className, style, children, }) => {
    ...
    return (react_1.default.createElement("div", Object.assign({}, htmlProps),
        react_1.default.createElement("button", { onClick: toggle, title: isFullScreen ? "Exit fullscreen" : "Enter fullscreen" },
